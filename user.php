...
<form method="post">
    <div class="row">
        ...
        <div class="col-md-6 text-right">
            ...
            <button type="button" onclick="location.href='user-baru.php'" class="btn btn-primary" style= "background-color: #5B913B; border-color: #5B913B;"><span class="fa fa-clone"></span> Tambah Data</button>
        </div>
    </div>
    <br/>
